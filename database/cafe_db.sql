...
('PR001', 'PHIN SỮA ĐÁ', 'CA01', 0, 29000, 'loading', b'0'),
('PR002', 'PHIN SỮA ĐÁ', 'CA01', 1, 39000, 'loading', b'0'),
('PR003', 'PHIN SỮA ĐÁ', 'CA01', 2, 45000, 'loading', b'0'),
('PR004', 'PHIN ĐEN ĐÁ', 'CA01', 0, 29000, 'loading', b'0'),
('PR005', 'PHIN ĐEN ĐÁ', 'CA01', 1, 35000, 'loading', b'0'),
('PR006', 'PHIN ĐEN ĐÁ', 'CA01', 2, 39000, 'loading', b'0'),
('PR007', 'BẠC XỈU', 'CA01', 0, 29000, 'loading', b'0'),
('PR008', 'BẠC XỈU', 'CA01', 1, 39000, 'loading', b'0'),
('PR009', 'BẠC XỈU', 'CA01', 2, 45000, 'loading', b'0'),
('PR010', 'PHINDI HẠNH NHÂN', 'CA02', 0, 45000, 'loading', b'0'),
('PR011', 'PHINDI HẠNH NHÂN', 'CA02', 1, 49000, 'loading', b'0'),
('PR012', 'PHINDI HẠNH NHÂN', 'CA02', 2, 55000, 'loading', b'0'),
('PR013', 'PHINDI KEM SỮA', 'CA02', 0, 45000, 'loading', b'0'),
('PR014', 'PHINDI KEM SỮA', 'CA02', 1, 49000, 'loading', b'0'),
('PR015', 'PHINDI KEM SỮA', 'CA02', 2, 55000, 'loading', b'0'),
('PR016', 'PHINDI CHOCO', 'CA02', 0, 45000, 'loading', b'0'),
('PR017', 'PHINDI CHOCO', 'CA02', 1, 49000, 'loading', b'0'),
('PR018', 'PHINDI CHOCO', 'CA02', 2, 55000, 'loading', b'0'),
('PR019', 'BÁNH MÌ PATE', 'CA03', 0, 19000, 'loading', b'0'),
('PR020', 'BÁNH MÌ GÀ PHÔ MAI', 'CA03', 0, 19000, 'loading', b'0'),
('PR021', 'TRÀ SEN VÀNG', 'CA04', 0, 45000, 'loading', b'0'),
('PR022', 'TRÀ SEN VÀNG', 'CA04', 1, 55000, 'loading', b'0'),
('PR023', 'TRÀ SEN VÀNG', 'CA04', 2, 65000, 'loading', b'0'),
('PR024', 'TRÀ THẠCH ĐÀO', 'CA04', 0, 45000, 'loading', b'0'),
('PR025', 'TRÀ THẠCH ĐÀO', 'CA04', 1, 55000, 'loading', b'0'),
('PR026', 'TRÀ THẠCH ĐÀO', 'CA04', 2, 65000, 'loading', b'0'),
('PR027', 'TRÀ THANH ĐÀO', 'CA04', 0, 45000, 'loading', b'0'),
('PR028', 'TRÀ THANH ĐÀO', 'CA04', 1, 55000, 'loading', b'0'),
('PR029', 'TRÀ THANH ĐÀO', 'CA04', 2, 65000, 'loading', b'0'),
('PR030', 'TRÀ THẠCH VẢI', 'CA04', 0, 45000, 'loading', b'0'),
('PR031', 'TRÀ THẠCH VẢI', 'CA04', 1, 55000, 'loading', b'0'),
('PR032', 'TRÀ THẠCH VẢI', 'CA04', 2, 65000, 'loading', b'0'),
('PR033', 'TRÀ XANH ĐẬU ĐỎ', 'CA04', 0, 45000, 'loading', b'0'),
('PR034', 'TRÀ XANH ĐẬU ĐỎ', 'CA04', 1, 55000, 'loading', b'0'),
('PR035', 'TRÀ XANH ĐẬU ĐỎ', 'CA04', 2, 65000, 'loading', b'0'),
('PR036', 'BÁNH CHUỐI', 'CA05', 0, 29000, 'loading', b'0'),
('PR037', 'PHÔ MAI CHANH DÂY', 'CA05', 1, 29000, 'loading', b'0'),
('PR038', 'TIRAMISU', 'CA05', 0, 35000, 'loading', b'0'),
('PR039', 'MOUSSE ĐÀO', 'CA05', 0, 35000, 'loading', b'0'),
('PR040', 'PHÔ MAI TRÀ XANH', 'CA05', 0, 35000, 'loading', b'0'),
('PR041', 'PHÔ MAI CARAMEL', 'CA05', 0, 35000, 'loading', b'0'),
('PR042', 'PHÔ MAI CACAO', 'CA05', 0, 35000, 'loading', b'0'),
('PR043', 'FREEZE TRÀ XANH', 'CA06', 0, 55000, 'loading', b'0'),
('PR044', 'FREEZE TRÀ XANH', 'CA06', 1, 65000, 'loading', b'0'),
('PR045', 'FREEZE TRÀ XANH', 'CA06', 2, 69000, 'loading', b'0'),
('PR046', 'CARAMEL PHIN FREEZE', 'CA06', 0, 55000, 'loading', b'0'),
('PR047', 'CARAMEL PHIN FREEZE', 'CA06', 1, 65000, 'loading', b'0'),
('PR048', 'CARAMEL PHIN FREEZE', 'CA06', 2, 69000, 'loading', b'0'),
('PR049', 'COOKIES & CREAM', 'CA06', 0, 55000, 'loading', b'0'),
('PR050', 'COOKIES & CREAM', 'CA06', 1, 65000, 'loading', b'0'),
('PR051', 'COOKIES & CREAM', 'CA06', 2, 69000, 'loading', b'0'),
('PR052', 'FREEZE SÔ-CÔ-LA', 'CA06', 0, 55000, 'loading', b'0'),
('PR053', 'FREEZE SÔ-CÔ-LA', 'CA06', 1, 65000, 'loading', b'0'),
('PR054', 'FREEZE SÔ-CÔ-LA', 'CA06', 2, 69000, 'loading', b'0'),
('PR055', 'CLASSIC PHIN FREEZE', 'CA06', 0, 55000, 'loading', b'0'),
('PR056', 'CLASSIC PHIN FREEZE', 'CA06', 1, 65000, 'loading', b'0'),
('PR057', 'CLASSIC PHIN FREEZE', 'CA06', 2, 69000, 'loading', b'0'),
('PR058', 'TRÀ SỮA BẠC HÀ', 'CA07', 0, 54000, 'loading', b'0'),
('PR059', 'TRÀ SỮA BẠC HÀ', 'CA07', 1, 59000, 'loading', b'0'),
('PR060', 'TRÀ SỮA TRÀ XANH', 'CA07', 0, 54000, 'loading', b'0'),
('PR061', 'TRÀ SỮA TRÀ XANH', 'CA07', 1, 59000, 'loading', b'0'),
('PR062', 'TRÀ SỮA DÂU', 'CA07', 0, 54000, 'loading', b'0'),
('PR063', 'TRÀ SỮA DÂU', 'CA07', 1, 59000, 'loading', b'0'),
('PR064', 'TRÀ SỮA SÔ-CÔ-LA', 'CA07', 0, 54000, 'loading', b'0'),
('PR065', 'TRÀ SỮA SÔ-CÔ-LA', 'CA07', 1, 59000, 'loading', b'0');
