...
public class StatisticGUI extends JPanel {
    ...
    public void initComponents() {
        ...
        btFunction[0].setPreferredSize(new Dimension(100,40));
        ...
        btFunction[0].setColorOver(new Color(0xB2B2B2));
        ...
        btFunction[1].setPreferredSize(new Dimension(100,40));
        ...
        btFunction[1].setColor(new Color(0x646464));
        btFunction[1].setColorOver(new Color(0xB2B2B2));
        ...
        btFunction[2].setPreferredSize(new Dimension(100,40));
        ...
        btFunction[2].setColor(new Color(0x646464));
        btFunction[2].setColorOver(new Color(0xB2B2B2));
        ...
        btFunction[3].setPreferredSize(new Dimension(100,40));
        ...
        btFunction[3].setColor(new Color(0x646464));
        btFunction[3].setColorOver(new Color(0xB2B2B2));
...
//        roundPanel[6].setBackground(new Color(182, 24, 24));
        ...
        roundPanel[7].setBackground(new Color(112, 225, 73));
        roundPanel[7].setPreferredSize(new Dimension(200, 200));
        ...
        roundPanel[9].setPreferredSize(new Dimension(200, 200));
        roundPanel[9].setAutoscrolls(true);
        roundPanel[5].add(roundPanel[9]);

        jLabel[3].setLayout(new FlowLayout(FlowLayout.CENTER,0,0));
        jLabel[3].setText("KHÁCH HÀNG");
        jLabel[3].setFont(new Font("Public Sans", Font.BOLD, 18));
        jLabel[3].setHorizontalAlignment(SwingConstants.CENTER);
        jLabel[3].setPreferredSize(new Dimension(200, 50));
        jLabel[3].setAutoscrolls(true);
        roundPanel[7].add(jLabel[3]);
        ...
        jLabel[4].setPreferredSize(new Dimension(200, 50));
        jLabel[4].setAutoscrolls(true);
        roundPanel[8].add(jLabel[4]);

        jLabel[5].setLayout(new FlowLayout(FlowLayout.CENTER,0,0));
        jLabel[5].setText("HÓA ĐƠN");
        jLabel[5].setFont(new Font("Public Sans", Font.BOLD, 18));
        jLabel[5].setHorizontalAlignment(SwingConstants.CENTER);
        jLabel[5].setPreferredSize(new Dimension(200, 50));
        jLabel[5].setAutoscrolls(true);
        roundPanel[9].add(jLabel[5]);
        ...
        roundPanel[11].setLayout(new FlowLayout(FlowLayout.CENTER,5,0));
...
//        jLabel[9].setForeground(new Color(255,255,255));
...
//        roundPanel[20].setBackground(new Color(250, 250, 250));
        ...
        //roundPanel[13].setBackground(new Color(182, 24, 24));
        ...
        //roundPanel[14].setBackground(new Color(182, 24, 24));
        roundPanel[14].add(new JScrollPane(dataTable[1]), BorderLayout.CENTER);
        roundPanel[14].setAutoscrolls(true);
        ...
        //roundPanel[15].setBackground(new Color(182, 24, 24));
        ...
        //roundPanel[16].setBackground(new Color(182, 24, 24));
