...
public class FrameCustomer extends JFrame{
        ...
        public void initComponents() {
            ...
            numberPhone = new ArrayList<String>();
            for (Customer customer : customerBLL.getCustomerList()) {
                System.out.println(1);
                numberPhone.add(customer.getPhone());
            }
